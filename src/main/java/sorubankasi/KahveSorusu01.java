...
String boyut oluşturun...
   ...
   HERKESE KOLAY GELSİN !! :)
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Hangi kahveyi istersiniz? : turk kahvesi / filtre kahve / ekspresso kahve");
        ...
        switch (hangiKahve) {
            case "turk kahve":
                System.out.println(hangiKahve + "niz " + "hazirlaniyor");
                break;
            case "filtre kahve":
                System.out.println(hangiKahve + " niz "+ " hazirlaniyor");
                break;
        ...
        System.out.println("sut eklememizi ister misiniz? : evet/hayir ");
        ...
        System.out.println("hangi boy olsun ?: kucuk / buyuk / orta ");
        String boyut = scan.next().toLowerCase().replaceAll(" ","");
